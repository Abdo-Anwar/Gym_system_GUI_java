...
public class View_registrations extends javax.swing.JFrame {

    /**
     * Creates new form View_registrations
     */
    private TrainerRole trainerRole;
    public View_registrations(TrainerRole trainerRole) {
    ...
    private void populateTrainerTable() {
        ...
        ArrayList<MemberClassRegistration> registrations = this.trainerRole.getListOfRegistrations();
...
//            java.util.logging.Logger.getLogger(View_registrations.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new View_registrations().setVisible(true);
//            }
//        });
//    }
