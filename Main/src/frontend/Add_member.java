...
public class Add_member extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt)
    {
        ...
        if(this.isCheckName ||this.isCheckStatus || this.isCheckPhone || this.isCheckMembership || this.isCheckId || this.isCheckEmail)
            JOptionPane.showMessageDialog(Container," Invalid Inputs !! ");
        else
            {
                            ...
                            if(checkExistance)
                                JOptionPane.showMessageDialog(Container," Member already exist !! ");
                            else
                                {
                                    trainerRole.addMember(this.id, this.name, this.email, this.phoneNumber, this.membershipType, this.status);
                                    JOptionPane.showMessageDialog(Container, " Member is added successfully !! ");
                                }
